        ...
        <ul class="nav navbar-nav">
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <!-- User Image -->
                        <img src="<c:url value='/static/images/user1-128x128.jpg'/>" class="img-circle" alt="User Image">
                      </div>
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <img src="<c:url value='/static/images/user2-160x160.jpg'/>" class="user-image" alt="User Image">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                <img src="<c:url value='/static/images/user2-160x160.jpg'/>" class="img-circle" alt="User Image">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div id="app-7">
        ...
        <button v-on:click="resetList">reset</button>
        <button v-on:click="updateList">get item</button>
        <button v-on:click="reverseList">reverse</button>
        <button v-on:click="echoList">echo</button>
      </div>
